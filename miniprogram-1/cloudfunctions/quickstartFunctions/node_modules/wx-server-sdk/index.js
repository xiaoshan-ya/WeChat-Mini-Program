...
function getGenericOpenAPI(cloud) {
    ...
    function callWXOpenAPI(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var data, key, items, key, val, pbMessage, callResult, result, e_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        data = tslib_1.__assign({}, options.data);
                        for (key in data) {
                            data[key.replace(/[A-Z]/g, function (match, ind) { return "" + (ind ? '_' : '') + match.toLowerCase(); })] = data[key];
                        }
                        items = [];
                        for (key in data) {
                            val = data[key];
                            // check whether it is a form-data item
                            if (type_1.isObject(val) && val.contentType && val.value && type_1.isBuffer(val.value)) {
                                items.push({
                                    key: key,
                                    value: val.value,
                                    content_type: val.contentType.toString(),
                                });
                            }
                            else {
                                items.push({
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                result: result,
                                errMsg: msg_1.apiSuccessMsg(options.api),
                            }];
                    case 2:
                        e_1 = _a.sent();
                        throw error_1.returnAsFinalCloudSDKError(e_1, options.api);
                    case 3: return [2 /*return*/];
                }
            });
        });
...
$root.ParamsItem = (function() {

    /**
     * Properties of a ParamsItem.
     * @exports IParamsItem
     * @interface IParamsItem
     * @property {string|null} [key] ParamsItem key
     * @property {Uint8Array|null} [value] ParamsItem value
     * @property {string|null} [contentType] ParamsItem contentType
     */

    /**
     * Constructs a new ParamsItem.
     * @exports ParamsItem
     * @classdesc Represents a ParamsItem.
     * @implements IParamsItem
     * @constructor
     * @param {IParamsItem=} [properties] Properties to set
     */
    function ParamsItem(properties) {
        if (properties)
     ...
     * @instance
     */
    ParamsItem.prototype.value = $util.newBuffer([]);

    /**
     * ParamsItem contentType.
     * @member {string} contentType
     * @memberof ParamsItem
     * @instance
     */
    ParamsItem.prototype.contentType = "";

    /**
     * Creates a new ParamsItem instance using the specified properties.
     * @function create
     * @memberof ParamsItem
     * @static
     * @param {IParamsItem=} [properties] Properties to set
     * @returns {ParamsItem} ParamsItem instance
     */
    ParamsItem.create = function create(properties) {
        return new ParamsItem(properties);
    };

    /**
     * Encodes the specified ParamsItem message. Does not implicitly {@link ParamsItem.verify|verify} messages.
     * @function encode
     * @memberof ParamsItem
     * @static
     * @param {IParamsItem} message ParamsItem message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ParamsItem.encode = function encode(message, writer) {
        if (!writer)
    ...
    /**
     * Encodes the specified ParamsItem message, length delimited. Does not implicitly {@link ParamsItem.verify|verify} messages.
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ParamsItem.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a ParamsItem message from the specified reader or buffer.
     * @function decode
     * @memberof ParamsItem
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ParamsItem} ParamsItem
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ParamsItem.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ParamsItem();
    ...
    /**
     * Decodes a ParamsItem message from the specified reader or buffer, length delimited.
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ParamsItem.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
     ...
     */
    ParamsItem.verify = function verify(message) {
    ...
    /**
     * Creates a ParamsItem message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof ParamsItem
     * @static
     ...
     * @returns {ParamsItem} ParamsItem
     */
    ParamsItem.fromObject = function fromObject(object) {
        if (object instanceof $root.ParamsItem)
            return object;
        var message = new $root.ParamsItem();
        if (object.key != null)
    ...
    /**
     * Creates a plain object from a ParamsItem message. Also converts values to other types if specified.
     * @function toObject
     * @memberof ParamsItem
     * @static
     * @param {ParamsItem} message ParamsItem
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ParamsItem.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
    ...
    /**
     * Converts this ParamsItem to JSON.
     * @function toJSON
     * @memberof ParamsItem
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    ParamsItem.prototype.toJSON = function toJSON() {
...
$root.OpenApiData = (function() {
     ...
     * @property {Array.<IParamsItem>|null} [items] OpenApiData items
     */
    ...
    /**
     * OpenApiData items.
     * @member {Array.<IParamsItem>} items
     * @memberof OpenApiData
     * @instance
     */
    OpenApiData.prototype.items = $util.emptyArray;
    ...
    OpenApiData.encode = function encode(message, writer) {
        ...
        if (message.items != null && message.items.length)
            for (var i = 0; i < message.items.length; ++i)
                $root.ParamsItem.encode(message.items[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        return writer;
    };
        ...
        while (reader.pos < end) {
            ...
            case 1:
                if (!(message.items && message.items.length))
                    message.items = [];
                message.items.push($root.ParamsItem.decode(reader, reader.uint32()));
                break;
            default:
                reader.skipType(tag & 7);
                break;
    ...
    OpenApiData.verify = function verify(message) {
        ...
        if (message.items != null && message.hasOwnProperty("items")) {
            ...
            for (var i = 0; i < message.items.length; ++i) {
                var error = $root.ParamsItem.verify(message.items[i]);
                if (error)
                    return "items." + error;
            }
        }
    ...
    OpenApiData.fromObject = function fromObject(object) {
        ...
        if (object.items) {
            if (!Array.isArray(object.items))
                throw TypeError(".OpenApiData.items: array expected");
            message.items = [];
            for (var i = 0; i < object.items.length; ++i) {
                if (typeof object.items[i] !== "object")
                    throw TypeError(".OpenApiData.items: object expected");
                message.items[i] = $root.ParamsItem.fromObject(object.items[i]);
            }
        }
        return message;
    };
    ...
    OpenApiData.toObject = function toObject(message, options) {
        ...
        if (message.items && message.items.length) {
            ...
            for (var j = 0; j < message.items.length; ++j)
                object.items[j] = $root.ParamsItem.toObject(message.items[j], options);
        }
        return object;
    };
